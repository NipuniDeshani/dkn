...
const configurationRuleSchema = new mongoose.Schema({
...
configurationRuleSchema.index({ key: 1 });
configurationRuleSchema.index({ category: 1 });

// Default configurations
configurationRuleSchema.statics.DEFAULTS = {
...
module.exports = mongoose.model('ConfigurationRule', configurationRuleSchema);
